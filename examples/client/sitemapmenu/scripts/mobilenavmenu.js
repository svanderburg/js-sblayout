 ...
 *   unordered list that embed a nested unordered list. The nested unordered list represent 2nd
     level menus
...
(function() {
    ...
    var basePath = "/examples/client/sitemapmenu"; // Base path of the web application
    ...
    window.dynamicOnload = function() { // onLoad event for dynamically loaded pages by the layout framework
        enabled = false;
        decideWhetherToEnableNavigationButton();
    };
